...
macro_rules! PSP_MODULE_INFO {
    ($mode:expr, $major_version:expr, $minor_version:expr) => (
        ...
        pub static module_info: ::raw::SceModuleInfo = ::raw::SceModuleInfo {
            ...
            terminal: 0,
            gp_value: unsafe{&_gp as *const _ as *const ()},
            ent_top: unsafe{&__lib_ent_top as *const _ as *const ()},
            ent_end: unsafe{&__lib_ent_bottom as *const _ as *const ()},
            stub_top: unsafe{&__lib_stub_top as *const _ as *const ()},
            stub_end: unsafe{&__lib_stub_bottom as *const _ as *const ()},
        };
    )
}
